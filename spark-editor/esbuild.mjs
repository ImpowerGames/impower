...
const PATTERNS_CSS = "../sparkle/src/patterns/patterns.css";
const ICONS_CSS = "../sparkle/src/styles/icons/icons.css";
const FALLBACK_CSS = "./src/styles/core/core.css";
...
const fallbackCSS = fs.readFileSync(FALLBACK_CSS, "utf8");
