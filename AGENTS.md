...
- Before the first slice of a sliced Feature is implemented, review its design with [review-spec-engineering](.agents/skills/review-spec-engineering/SKILL.md); when the feature changes a language, interface or player surface an author touches, also run [review-spec-experience](.agents/skills/review-spec-experience/SKILL.md). Both are user-invoked after file-feature and before resolve-issue.
