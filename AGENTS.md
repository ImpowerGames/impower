...
- Before the first slice of a sliced Feature is implemented, review its design with [review-feature-engineering](.agents/skills/review-feature-engineering/SKILL.md). When a Feature changes a language, interface or player surface an author touches, sliced or not, also run [review-feature-experience](.agents/skills/review-feature-experience/SKILL.md). Each runs in a fresh session of a different model than the one that filed the feature, after file-feature and before resolve-issue.
