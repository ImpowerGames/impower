  ...
  resolveWebviewView(webviewView: vscode.WebviewView): void | Thenable<void> {
    ...
    webviewView.webview.html = `<!DOCTYPE html>
        ...
        <head>
            ...
            <style>
            @font-face{
                font-family: sparkdown-screenplayfont;
                src:url(${fontUri});
                font-weight: normal;
            }
            @font-face{
...
const getCheatSheet = (): Record<string, CheatsheetItem[]> => {
  ...
  cheatSheet["Scenes"] = [
    ...
    new CheatsheetItem(
      "EST.",
      "Establishing scene",
      "<span class='scene'>EST. CITY - NIGHT</span>"
    ),
    new CheatsheetItem(
      "INT./EXT.",
    ...
    new CheatsheetItem(
      "I/E.",
      "Indoor and Outdoor scene",
      "<span class='scene'>I/E. RONNA'S CAR - NIGHT [DRIVING]</span>"
    ),
    new CheatsheetItem(
      "TO:",
...
<span class='dialogue'>Did you know Brick and Steel are retired?</span>`
    ...
    new CheatsheetItem(
      "/* ignore text */",
      "If you want Sparkdown to ignore some text, wrap it with /* some text */",
