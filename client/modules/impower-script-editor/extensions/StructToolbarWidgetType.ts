...
export class StructToolbarWidgetType extends WidgetType {
  toDOM(): HTMLElement {
    ...
    autofillButton.className = "cm-struct-toolbar-autofill";
    autofillButton.innerHTML = PenFieldIcon;
    autofillButton.style.color = "white";
    autofillButton.style.fill = "currentColor";
    autofillButton.style.width = "1rem";
    autofillButton.style.height = "1rem";
    autofillButton.style.display = "flex";
    autofillButton.style.justifyContent = "center";
    autofillButton.style.alignItems = "center";
    autofillButton.style.backgroundColor = "transparent";
    autofillButton.style.padding = "0";
    autofillButton.style.margin = "2px 4px";
    autofillButton.style.border = "none";
    (autofillButton.firstElementChild as HTMLElement).style.pointerEvents =
      "none";
    root.appendChild(autofillButton);
    return root;
  }
