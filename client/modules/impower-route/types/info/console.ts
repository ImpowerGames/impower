...
export const studioConsoles: EngineConsoleInfo[] = [
  {
    ...
    doneLabel: "Done",
    noneLabel: "(No Games)",
    finishCreationLabel: "Create Game",
    finishEditLabel: "Save Changes",
    searchLabel: "Search...",
    clearLabel: "Clear",
    sortLabel: "Sort By",
  ...
  {
    type: EngineConsoleType.Resources,
    name: "Resources",
    tab: "resources",
    ...
    nextLabel: "Next",
    doneLabel: "Done",
    noneLabel: "(No Resources)",
    finishCreationLabel: "Create Resource",
    finishEditLabel: "Save Changes",
    searchLabel: "Search...",
    clearLabel: "Clear",
    sortLabel: "Sort By",
    filterLabel: "Filter By",
    urlLabel: "Open Public Page",
    addingMessage: "Creating Resource...",
