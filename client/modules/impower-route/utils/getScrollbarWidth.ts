...
export const getScrollbarWidth: IScrollbarWidth = (
  force?: boolean
): number | undefined => {
  ...
  if (force !== true && typeof getScrollbarWidth.__cache === "number") {
    return getScrollbarWidth.__cache;
  }
  ...
  getScrollbarWidth.__cache = 100 - clientWidth;
