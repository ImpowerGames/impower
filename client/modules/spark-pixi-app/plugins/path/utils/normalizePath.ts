  ...
  segments.forEach(({ command, data }) => {
    switch (command) {
      ...
      case "C":
        ...
        break;
      case "L":
        out.push({ command: "C", data: lineToCurve(data[0], data[1], cx, cy) });
        [cx, cy] = data;
        break;
      case "H":
        cx = data[0];
      ...
      case "S": {
        ...
        out.push({ command: "C", data: [cx1, cy1, ...data] });
        lcx = data[0];
        lcy = data[1];
        cx = data[2];
        cy = data[3];
      ...
      case "T": {
        ...
        out.push({ command: "C", data: [cx1, cy1, cx2, cy2, x, y] });
        lcx = x1;
        lcy = y1;
        cx = x;
        cy = y;
      ...
      case "A": {
        ...
        const y = data[6];
        if (r1 === 0 || r2 === 0) {
          out.push({ command: "C", data: [cx, cy, x, y, x, y] });
          cx = x;
          cy = y;
        } else if (cx !== x || cy !== y) {
