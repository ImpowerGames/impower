...
Most sessions meet nothing that passes both, and post nothing. The inbox is the only destination for feedback: the maintainer reads it there, so the chat handoff neither restates a report nor says that there was none.
