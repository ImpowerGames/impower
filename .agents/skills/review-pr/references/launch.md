...
- Blast radius: enumerate callers of changed functions and assess their behavior, citing `file:line`. An unaccounted-for caller is a coverage gap until evidence establishes a failure scenario.
