...
ARG _BROWSER_GOOGLE_API_KEY
ENV _BROWSER_GOOGLE_API_KEY ${_BROWSER_GOOGLE_API_KEY}
ARG _BROWSER_GOOGLE_OAUTH_CLIENT_ID
ENV _BROWSER_GOOGLE_OAUTH_CLIENT_ID ${_BROWSER_GOOGLE_OAUTH_CLIENT_ID}
