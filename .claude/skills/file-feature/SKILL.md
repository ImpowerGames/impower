...
Judgement calls, which are the only thing this list holds: no mechanism can make them for you, and a rule that holds for the whole repository (the heredoc one, say) belongs in `CLAUDE.md` instead.
