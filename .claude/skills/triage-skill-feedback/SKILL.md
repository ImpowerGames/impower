...
If interrupted, use the original unedited plan and its original script version. Markers recover ticket or evidence creation whose response was lost; the body's run marker and integrity check recover folding before deletion. If the body records intake as folded while those comments remain live, preserve the original plan and saved body artifacts and reconcile the unfinished cleanup; a fresh plan refuses to fold them twice. Do not restore a saved body or delete comments automatically. Keep other triage sessions stopped until recovery is complete.
