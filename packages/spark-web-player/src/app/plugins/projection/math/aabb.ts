...
export class AABB {
  ...
  private _min = new Point3D(0, 0, 0, this.observer);
  private _max = new Point3D(0, 0, 0, this.observer);
  private _center = new Point3D(0, 0, 0);
  private _size = new Point3D(0, 0, 0);
  private _extents = new Point3D(0, 0, 0);
