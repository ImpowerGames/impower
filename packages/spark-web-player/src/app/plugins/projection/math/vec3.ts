...
export class Vec3 {
  static right = new Float32Array([1, 0, 0]);
  static up = new Float32Array([0, 1, 0]);
  static set(
    x: number,
    y: number,
    z: number,
  ...
  static normalize(a: Float32Array, out: Float32Array = new Float32Array(3)) {
  ...
  static copy(a: Float32Array, out: Float32Array = new Float32Array(3)) {
  ...
  static inverse(a: Float32Array, out: Float32Array = new Float32Array(3)) {
    return <Float32Array>vec3.inverse(out, a);
  }
  static negate(a: Float32Array, out: Float32Array = new Float32Array(3)) {
