...
import {
  COMPILER_ARRAY_INTERVAL,
  FINISH_INCOMPLETE_NODES,
...
export class Compiler {
  declare language: TextmateLanguage;
  ...
  constructor(language: TextmateLanguage, buffer?: ChunkBuffer) {
  ...
  private emit(type: number, from: number, to: number, children: number) {
    ...
    //   "EMIT",
    //   type,
    //   this.language.nodeTypes?.[type]?.name,
    //   from,
    //   to,
    //   children
    // );
