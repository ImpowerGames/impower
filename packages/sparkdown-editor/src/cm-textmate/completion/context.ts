 ...
 * Textmate autocomplete handlers.
 */
export class TextmateCompletionContext extends CompletionContext {
  /** The {@link ParserNode} type used by the node at the current position. */
  declare type: ParserNode;
   ...
   * {@link TextmateCompletionContext}.
   *
   * @param context - The `CompletionContext` to mutate.
   * @param type - The {@link ParserNode} type.
  ...
  static mutate(
    ...
    if (Object.getPrototypeOf(context) === this.prototype) {
      return context as TextmateCompletionContext;
    }
    ...
    return mutated as TextmateCompletionContext;
  }
  ...
  /** The {@link ParserNode} type of the {@link around} node. */
  get aroundType() {
  ...
  /**
   * Gets the {@link ParserNode} type of a `SyntaxNode`.
   *
  ...
  isInbetween(left: string, right = left) {
    ...
    if (leftNode.name !== left || rightNode.name !== right) {
      return false;
    }
    return true;
  }
