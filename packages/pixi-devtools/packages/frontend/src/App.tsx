        ...
        case 'pixi-state-update':
          {
            ...
            data.version && isDifferent(currentState.version, data.version) && setVersion(data.version);
            data.stats && isDifferent(currentState.stats, data.stats) && setStats(data.stats);
          }
          break;
