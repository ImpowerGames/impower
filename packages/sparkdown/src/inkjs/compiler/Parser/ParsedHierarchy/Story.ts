...
export class Story extends FlowBase {
   ...
   *  name and fails when run. `warning` marks a divert whose name a local or
   *  parameter elsewhere in its call-stack element declares, so what it
   *  binds to depends on whether that declaration has been set when it runs.
