...
export const isBeforeInstallPromptEvent = (
  obj: unknown
): obj is BeforeInstallPromptEvent => {
  if (!obj) {
    return false;
  }
  const beforeInstallPromptEvent = obj as BeforeInstallPromptEvent;
  return (
    beforeInstallPromptEvent.platforms !== undefined &&
    beforeInstallPromptEvent.userChoice !== undefined &&
    beforeInstallPromptEvent.prompt !== undefined
  );
};
