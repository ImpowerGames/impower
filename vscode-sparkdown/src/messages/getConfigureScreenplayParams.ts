import { ScreenplayOptions } from "@impower/spark-editor-protocol/src/types/ScreenplayOptions";
import { SparkdownPreviewConfig } from "../types/SparkdownPreviewConfig";

export const getScreenplayOptions = (
  configuration: SparkdownPreviewConfig
): ScreenplayOptions => {
  return {
