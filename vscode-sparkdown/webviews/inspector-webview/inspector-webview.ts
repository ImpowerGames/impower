import SparkdownInspector from "@impower/sparkdown-inspector/src/index.js";

console.log("running inspector-webview");
...
const load = async () => {
  await Promise.allSettled([SparkdownInspector.init()]);
