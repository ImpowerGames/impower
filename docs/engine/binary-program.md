...
- Nothing the look-ahead kept is in a beat's image, so a rewind undoes what the logic after a line did and a roll forward runs it again, once, as a load does.
