...
| Errors and warnings the current continue has raised | two arrays | not held: they belong to the continue that raised them, which hands them to `onError` when it returns and clears them (`Story.ts:1350-1362`) |
